...
class ReceiptPrinter:
    ...
    def print_receipt_item(self, item: ReceiptItem):
    ...
    def format_line_with_whitespace(self, name: str, value: str):
        line = name
    ...
    def present_total(self, receipt: Receipt):
        name = "Total: "
